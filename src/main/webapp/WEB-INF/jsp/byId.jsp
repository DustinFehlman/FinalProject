...
<section class="container">
    ...
    <div class="row" style="padding-bottom:100px">
        ...
        <div>
            <a href=" <spring:url value= "/order" /> " class="btn btn-lg btn-success" id="Home" role="button" style="position:fixed;right:300px;bottom:20px">Next Order</a>
            <a href=" <spring:url value= "/shipment/all" /> " class="btn btn-lg btn-primary" id="All" role="button" style="position:fixed;right:150px;bottom:20px">Order History</a>
